<!-- resources/views/quizzes/class_viii.blade.php -->
...
@section('content')
    ...
    <div class="d-flex flex-column siswa-detail">
        <div class="card siswa-detail-detail" style="padding-bottom:30px;">
            <p class="card-text" style="width: 90%; margin-top: 30px; margin-bottom:10px;">1. Question for class VIII.</p>
        ...
        <div class="card siswa-detail-detail" style="padding-bottom:30px; margin-top: 10px;">
            <p class="card-text" style="width: 90%; margin-top: 30px; margin-bottom:10px;">2. Another question for class VIII.</p>
            <div class="form-check" style="width: 80%;">
